    ...
    <form id="RegistrationForm" runat="server">
        <div class="p-4 md:p-6">
            <asp:Panel ID="RegistrationPanel" runat="server" CssClass="w-full sm:w-8/12 md:w-6/12 bg-white rounded-lg shadow-lg p-6 md:p-10 mx-auto font-sans">
                <h2 class="text-2xl font-bold text-center text-[#19A2E6] mb-6">Customer Register</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="Mobile" runat="server"
                                CssClass="w-full px-3 py-2 border rounded-lg focus:ring focus:ring-indigo-200 focus:outline-none !important"
                                Placeholder="Mobile No" TextMode="SingleLine">
                            </asp:TextBox>
